...
// ── Additional UI strings (comprehensive sweep) ────────────────────────────
  ...
  // ── Toast messages ─────────────────────────────────────────────────────────
  'toast.all_deleted':       {pt:'Todos excluídos!',          en:'All deleted!',              es:'¡Todos eliminados!',           fr:'Tous supprimés !'},
  'toast.backup_deleted':    {pt:'Backup excluído.',          en:'Backup deleted.',           es:'Backup eliminado.',            fr:'Sauvegarde supprimée.'},
  'toast.backup_downloaded': {pt:'Backup baixado!',           en:'Backup downloaded!',        es:'¡Backup descargado!',          fr:'Sauvegarde téléchargée !'},
  'toast.backup_ok':         {pt:'Backup criado com sucesso!',en:'Backup created!',           es:'¡Backup creado!',              fr:'Sauvegarde créée !'},
  'toast.backup_restored':   {pt:'Backup restaurado!',        en:'Backup restored!',          es:'¡Backup restaurado!',          fr:'Sauvegarde restaurée !'},
  'toast.cache_cleared':     {pt:'Cache limpo!',              en:'Cache cleared!',            es:'¡Caché limpiado!',             fr:'Cache vidé !'},
  'toast.cat_edit_parent':   {pt:'Edite pela categoria pai.', en:'Edit via parent category.', es:'Editar en la categoría padre.', fr:'Modifier via la catégorie parente.'},
  'toast.copied':            {pt:'Copiado!',                  en:'Copied!',                   es:'¡Copiado!',                    fr:'Copié !'},
  'toast.email_sent':        {pt:'E-mail enviado!',           en:'Email sent!',               es:'¡Correo enviado!',             fr:'E-mail envoyé !'},
  'toast.emailjs_saved':     {pt:'Configuração EmailJS salva!',en:'EmailJS config saved!',    es:'¡Config EmailJS guardada!',    fr:'Config EmailJS enregistrée !'},
  'toast.err_account_name':  {pt:'Informe o nome da conta.',  en:'Enter account name.',       es:'Ingrese el nombre de la cuenta.',fr:'Saisissez le nom du compte.'},
  'toast.err_description':   {pt:'Informe a descrição.',      en:'Enter description.',        es:'Ingrese la descripción.',      fr:'Saisissez la description.'},
  'toast.err_group_name':    {pt:'Informe o nome do grupo.',  en:'Enter group name.',         es:'Ingrese el nombre del grupo.', fr:'Saisissez le nom du groupe.'},
  'toast.err_load_tx':       {pt:'Erro ao carregar transações.',en:'Error loading transactions.',es:'Error al cargar transacciones.',fr:'Erreur de chargement des transactions.'},
  'toast.err_name':          {pt:'Informe o nome.',           en:'Enter name.',               es:'Ingrese el nombre.',           fr:'Saisissez le nom.'},
  'toast.err_select_account':{pt:'Selecione uma conta.',      en:'Select an account.',        es:'Seleccione una cuenta.',       fr:'Sélectionnez un compte.'},
  'toast.err_select_cat':    {pt:'Selecione uma categoria.',  en:'Select a category.',        es:'Seleccione una categoría.',    fr:'Sélectionnez une catégorie.'},
  'toast.err_start_date':    {pt:'Informe a data de início.', en:'Enter start date.',         es:'Ingrese la fecha de inicio.',  fr:'Saisissez la date de début.'},
  'toast.group_removed':     {pt:'Grupo removido.',           en:'Group removed.',            es:'Grupo eliminado.',             fr:'Groupe supprimé.'},
  'toast.group_saved':       {pt:'Grupo salvo!',              en:'Group saved!',              es:'¡Grupo guardado!',             fr:'Groupe enregistré !'},
  'toast.member_removed':    {pt:'Membro removido.',          en:'Member removed.',           es:'Miembro eliminado.',           fr:'Membre supprimé.'},
  'toast.name_updated':      {pt:'Nome atualizado!',          en:'Name updated!',             es:'¡Nombre actualizado!',         fr:'Nom mis à jour !'},
  'toast.no_diff':           {pt:'Nenhuma diferença encontrada.',en:'No differences found.',  es:'No se encontraron diferencias.',fr:'Aucune différence trouvée.'},
  'toast.no_row_selected':   {pt:'Nenhuma linha selecionada.',en:'No row selected.',          es:'Ninguna fila seleccionada.',   fr:'Aucune ligne sélectionnée.'},
  'toast.pwd_changed':       {pt:'Senha alterada com sucesso!',en:'Password changed!',        es:'¡Contraseña cambiada!',        fr:'Mot de passe modifié !'},
  'toast.receipt_filled':    {pt:'Campos preenchidos pelo recibo!',en:'Fields filled from receipt!',es:'¡Campos completados del recibo!',fr:'Champs remplis depuis le reçu !'},
  'toast.supabase_ok':       {pt:'Conexão Supabase OK!',      en:'Supabase connection OK!',   es:'¡Conexión Supabase OK!',       fr:'Connexion Supabase OK !'},

  // ── Transactions ─────────────────────────────────────────────────────────────
  'tx.deleted':              {pt:'Transação excluída.',        en:'Transaction deleted.',      es:'Transacción eliminada.',       fr:'Transaction supprimée.'},
  'tx.err_date_account':     {pt:'Informe data e conta.',      en:'Enter date and account.',   es:'Ingrese fecha y cuenta.',      fr:'Saisissez la date et le compte.'},
  'tx.not_found':            {pt:'Transação não encontrada.',  en:'Transaction not found.',    es:'Transacción no encontrada.',   fr:'Transaction introuvable.'},
  'tx.new':                  {pt:'+ Nova Transação',           en:'+ New Transaction',         es:'+ Nueva transacción',          fr:'+ Nouvelle transaction'},
  'tx.edit':                 {pt:'Editar Transação',           en:'Edit Transaction',          es:'Editar transacción',           fr:'Modifier la transaction'},
  'tx.copy':                 {pt:'Nova Transação (cópia)',     en:'New Transaction (copy)',     es:'Nueva transacción (copia)',    fr:'Nouvelle transaction (copie)'},
  'tx.modal_title_detail':   {pt:'Detalhe da Transação',       en:'Transaction Detail',         es:'Detalle de transacción',       fr:'Détail de la transaction'},

  // ── Accounts ──────────────────────────────────────────────────────────────────
  'account.deleted':         {pt:'Conta excluída.',            en:'Account deleted.',          es:'Cuenta eliminada.',            fr:'Compte supprimé.'},
  'account.not_found':       {pt:'Conta não encontrada.',      en:'Account not found.',        es:'Cuenta no encontrada.',        fr:'Compte introuvable.'},
  'account.new':             {pt:'Nova Conta',                 en:'New Account',               es:'Nueva cuenta',                 fr:'Nouveau compte'},
  'account.edit':            {pt:'Editar Conta',               en:'Edit Account',              es:'Editar cuenta',                fr:'Modifier le compte'},
  'account.saved':           {pt:'Conta salva!',               en:'Account saved!',            es:'¡Cuenta guardada!',            fr:'Compte enregistré !'},
  'account.updated':         {pt:'Conta atualizada!',          en:'Account updated!',          es:'¡Cuenta actualizada!',         fr:'Compte mis à jour !'},
  'account.confirm_delete':  {pt:'Confirmar Exclusão',         en:'Confirm Delete',            es:'Confirmar eliminación',        fr:'Confirmer la suppression'},

  // ── Categories ───────────────────────────────────────────────────────────────
  'category.deleted':        {pt:'Categoria excluída.',        en:'Category deleted.',         es:'Categoría eliminada.',         fr:'Catégorie supprimée.'},
  'category.deleted_simple': {pt:'Categoria removida.',        en:'Category removed.',         es:'Categoría eliminada.',         fr:'Catégorie supprimée.'},
  'category.saved':          {pt:'Categoria salva!',           en:'Category saved!',           es:'¡Categoría guardada!',         fr:'Catégorie enregistrée !'},
  'category.new':            {pt:'Nova Categoria',             en:'New Category',              es:'Nueva categoría',              fr:'Nouvelle catégorie'},
  'category.new_sub':        {pt:'Nova Subcategoria',          en:'New Subcategory',           es:'Nueva subcategoría',           fr:'Nouvelle sous-catégorie'},
  'category.edit':           {pt:'Editar Categoria',           en:'Edit Category',             es:'Editar categoría',             fr:'Modifier la catégorie'},

  // ── Payees ────────────────────────────────────────────────────────────────────
  'payee.deleted':           {pt:'Beneficiário excluído.',     en:'Payee deleted.',            es:'Beneficiario eliminado.',      fr:'Bénéficiaire supprimé.'},
  'payee.new':               {pt:'Novo Beneficiário',          en:'New Payee',                 es:'Nuevo beneficiario',           fr:'Nouveau bénéficiaire'},
  'payee.edit':              {pt:'Editar Beneficiário',        en:'Edit Payee',                es:'Editar beneficiario',          fr:'Modifier le bénéficiaire'},

  // ── Budgets ───────────────────────────────────────────────────────────────────
  'budget.new':              {pt:'Novo Orçamento',             en:'New Budget',                es:'Nuevo presupuesto',            fr:'Nouveau budget'},
  'budget.edit':             {pt:'Editar Orçamento',           en:'Edit Budget',               es:'Editar presupuesto',           fr:'Modifier le budget'},
  'budget.saved':            {pt:'Orçamento salvo!',           en:'Budget saved!',             es:'¡Presupuesto guardado!',       fr:'Budget enregistré !'},
  'budget.updated':          {pt:'Orçamento atualizado!',      en:'Budget updated!',           es:'¡Presupuesto actualizado!',    fr:'Budget mis à jour !'},
  'budget.no_tx':            {pt:'Nenhuma transação no período',en:'No transactions in period',es:'Sin transacciones en el período',fr:'Aucune transaction dans la période'},

  // ── Scheduled ─────────────────────────────────────────────────────────────────
  'scheduled.saved':         {pt:'Transação programada!',      en:'Transaction scheduled!',    es:'¡Transacción programada!',     fr:'Transaction programmée !'},
  'scheduled.updated':       {pt:'Programação atualizada!',    en:'Schedule updated!',         es:'¡Programación actualizada!',   fr:'Programmation mise à jour !'},
  'scheduled.new':           {pt:'Programar Transação',        en:'Schedule Transaction',      es:'Programar transacción',        fr:'Programmer une transaction'},
  'scheduled.edit':          {pt:'Editar Programação',         en:'Edit Schedule',             es:'Editar programación',          fr:'Modifier la programmation'},
  'scheduled.copy':          {pt:'Nova Programação (cópia)',   en:'New Schedule (copy)',       es:'Nueva programación (copia)',   fr:'Nouvelle programmation (copie)'},
  'scheduled.transfer_dest': {pt:'Conta Destino *',            en:'Destination Account *',     es:'Cuenta destino *',             fr:'Compte de destination *'},
  'scheduled.card_dest':     {pt:'Cartão de Crédito (Destino) *',en:'Credit Card (Destination) *',es:'Tarjeta de crédito (destino) *',fr:'Carte de crédit (destination) *'},

  // ── Errors ────────────────────────────────────────────────────────────────────
  'error.admin_only':        {pt:'Apenas administradores.',    en:'Admins only.',              es:'Solo administradores.',        fr:'Administrateurs seulement.'},
  'error.load_data':         {pt:'Erro ao carregar dados.',    en:'Error loading data.',       es:'Error al cargar datos.',       fr:'Erreur de chargement des données.'},
  'error.supabase_config':   {pt:'Configuração Supabase inválida.',en:'Invalid Supabase config.',es:'Config Supabase inválida.',  fr:'Config Supabase invalide.'},
  'error.generic':           {pt:'Erro: ',                     en:'Error: ',                   es:'Error: ',                      fr:'Erreur : '},
  'error.family_not_found':  {pt:'Família não identificada.',  en:'Family not found.',         es:'Familia no identificada.',     fr:'Famille introuvable.'},

  // ── Profile / Auth modal ──────────────────────────────────────────────────────
  'profile.updated':         {pt:'Perfil atualizado!',         en:'Profile updated!',          es:'¡Perfil actualizado!',         fr:'Profil mis à jour !'},
  'auth.save_pwd':           {pt:'Salvar Nova Senha',          en:'Save New Password',         es:'Guardar nueva contraseña',     fr:'Enregistrer le nouveau mot de passe'},

  // ── Reports ───────────────────────────────────────────────────────────────────
  'report.export_ok':        {pt:'Relatório exportado!',       en:'Report exported!',          es:'¡Informe exportado!',          fr:'Rapport exporté !'},
  'report.pdf_ok':           {pt:'PDF gerado!',                en:'PDF generated!',            es:'¡PDF generado!',               fr:'PDF généré !'},

  // ── AI ────────────────────────────────────────────────────────────────────────
  'ai.analysis_done':        {pt:'Análise concluída.',         en:'Analysis complete.',        es:'Análisis completado.',         fr:'Analyse terminée.'},
  'ai.no_api_key_config':    {pt:'Chave de API não configurada.',en:'API key not configured.', es:'Clave de API no configurada.', fr:'Clé API non configurée.'},

  // ── Family management ─────────────────────────────────────────────────────────
  'family.new':              {pt:'Nova Família',               en:'New Family',                es:'Nueva familia',                fr:'Nouvelle famille'},
  'family.edit':             {pt:'Editar Família',             en:'Edit Family',               es:'Editar familia',               fr:'Modifier la famille'},
  'family.saved':            {pt:'Família salva!',             en:'Family saved!',             es:'¡Familia guardada!',           fr:'Famille enregistrée !'},

  // ── User admin ────────────────────────────────────────────────────────────────
  'user.new':                {pt:'Novo Usuário',               en:'New User',                  es:'Nuevo usuario',                fr:'Nouvel utilisateur'},
  'user.edit':               {pt:'Editar Usuário',             en:'Edit User',                 es:'Editar usuario',               fr:'Modifier l\'utilisateur'},

  // ── Settings ──────────────────────────────────────────────────────────────────
  'settings.save_pin':       {pt:'Salvar PIN',                 en:'Save PIN',                  es:'Guardar PIN',                  fr:'Enregistrer le PIN'},

  // ── Debt module ───────────────────────────────────────────────────────────────
  'debt.transfer_dest':      {pt:'Conta Destino *',            en:'Destination Account *',     es:'Cuenta destino *',             fr:'Compte de destination *'},
  'debt.card_dest':          {pt:'Cartão de Crédito (Destino) *',en:'Credit Card (Destination) *',es:'Tarjeta de crédito (destino) *',fr:'Carte de crédit (destination) *'},
